...
- Km 越小，酶和底物亲和力越强
- Kcat反转数，酶活性中心活性
- Kcat = Vmax / [E0], 单位时间里单位反应中心可将多少摩尔底物转化为产物
- 专一性常数 kcat/Km 
- 当[S]<< Km, v=(kcat/Km)[E0][S]

#### graphical representation of kenetic data
...
- fundamentals - two approaches from <++>
+ collision
    - basec assumption
    - v = k^coll [A][B]
+ transition state theory
    - 并不是酶和底物亲和力愈大越好，而是酶和底物达到过渡态所需能量越小越好
    - 活性中心应当更趋向于稳定过渡态更好，而不是倾向于和底物结合
    - <++>

- loss of Entropy
+ entropy is composed of <++>
+ <++>
+ the internal entropy can also lose during the formation of the ES complex

- destabilization if the ES complex
- <++>
- desolvation
- electrostatic destabilization

- approximation of reactants
+ intramoleculear catalysis - steric crowding
...
- the property of inhibition
 ...
 + irreversible inhibition
     + the activity can not be recovered by dilution or removal of the inhibitors, due to <++>
